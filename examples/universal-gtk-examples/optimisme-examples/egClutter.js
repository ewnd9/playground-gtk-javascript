...
// transformed from /vendor/optimisme-examples/egClutter.js by /scripts/transform-examples.js
// (license unspecified)

const { Gdk } = require('universal-gtk');
const { Clutter } = require('universal-gtk');
const { GtkClutter } = require('universal-gtk');
const { Gio } = require('universal-gtk');
const { GLib } = require('universal-gtk');
