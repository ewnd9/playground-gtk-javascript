...
// transformed from /vendor/programmica-examples/iconview.js by /scripts/transform-examples.js
// (license CC0-1.0)

const { Gtk } = require('universal-gtk');
const { GdkPixbuf } = require('universal-gtk');
const { GObject } = require('universal-gtk');
